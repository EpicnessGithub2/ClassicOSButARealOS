...
UnhandledExceptionFilter(IN PEXCEPTION_POINTERS ExceptionInfo)
{
    ...
    /* classicOS-specific: DPRINT a stack trace */
    ...
    // TODO: Start a classicOS Fault Reporter (unimplemented!)
    //
    ...
    /* If the exception comes from a CSR Server, kill it (this will lead to classicOS shutdown) */
               ...
               IN CONST ULONG_PTR *lpArguments OPTIONAL)
{
    ...
    /* Better handling of Delphi Exceptions... a classicOS Hack */
