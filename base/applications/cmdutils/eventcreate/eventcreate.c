 ...
 * PROJECT:         classicOS EventCreate Command
 ...
 *    large file.
 *
 *    For classicOS I want to have a compromise between disk space and usage
 ...
 *
 * classicOS' EventCreate.exe command uses the same limits as Powershell.
 */
    ...
    IN LPCWSTR EventLogSource)
{
     ...
     * - In case of success, try to replace the classicOS installation path
...
int wmain(int argc, WCHAR* argv[])
{
    ...
    OPTION Options[] =
    {
        ...
        /* Event category (classicOS additional option) */
