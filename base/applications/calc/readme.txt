...
INTRODUCTION
=============
This is classicOS Calc, a scientific calculator for Win32 and Win64 systems.
...
The user interface of classicOS Calc is really similar to Microsoft calculator, so you should be able to use this replacement very quickly.

COMPILATION
============
You need MinGW for compiling classicOS Calc.
...
========================
classicOS Calc uses HTMLHELP for opening the help file and generating the popups.
...
For classicOS users, it must be \classicOS\Help (at the moment the Help directory doesn't exists, so it must be created manually).

NOTES TO classicOS USERS
=========================
At the time of the write of this text, the newest version of classicOS is 0.3.4.
While classicOS Calc works fine with Microsoft's operating systems, there are some known issues with classicOS:
...
* Into the aboutbox, the color around the classicOS's logo isn't applied.
...
Although classicOS Calc is pretty simple and I still think you should be able to understand the basic operations yourself, a good manual would be a nice presentation for new users.
