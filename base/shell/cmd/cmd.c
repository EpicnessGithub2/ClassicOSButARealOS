 ...
 *        Workaround because argc[0] is NULL under classicOS
 *
    ...
    IN BOOL (*GetVar)(TCHAR, PCTSTR*, BOOL*))
{
    ...
    *pFormat = FormatEnd + 1;
     ...
     * C:\ReAcToS -> C:\classicOS) and, if requested with the S modifier,
...
Initialize(VOID)
{
    ...
    /* Some people like to run classicOS cmd.exe on Win98, it helps in the
