...
IntPrintUsage()
{
    cout << "rosautotest - classicOS Automatic Testing Utility" << endl
         ...
         << "    /r           - Maintain information to resume from classicOS crashes" << endl
         << "                   Can only be run under classicOS and relies on sysreg2," << endl
