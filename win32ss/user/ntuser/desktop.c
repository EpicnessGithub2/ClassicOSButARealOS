                       ...
                       IN BOOLEAN AppendNtSystemRoot)
{
    ...
    if (InSafeMode)
    {
        ...
        Status = RtlStringCchPrintfW(pwszzVersion,
                                     cchDest,
                                     L"classicOS Version %S %wZ (NT %u.%u Build %u%s)\n",
                                     KERNEL_VERSION_STR,
                                     &BuildLabString,
...
IntSetFocusMessageQueue(PUSER_MESSAGE_QUEUE NewQueue)
{
    ...
    else
    {
        ...
        ptiLastInput = NULL; // classicOS hacks... should check for process death.
    }
}
