...
typedef struct
{
    ...
    HBITMAP   hBmpClose; /* classicOS modification */
} MDICLIENTINFO;
...
#ifdef __REACTOS__
	PostMessageA( hwnd, WM_MDICALCCHILDSCROLL, 0, 0 ); //// classicOS: Post not send!
#else
...
void WINAPI CalcChildScroll( HWND hwnd, INT scroll )
{
    ...
    *
    * Apparently (in classicOS at least) the rcClient returned by GetWindowInfo
