 ...
 * Released under the GNU GPL for the classicOS project
 *
 * This program can be used to spy on a named pipe in Windows NT(+)
 * or classicOS.  It is particularly intended to be used for
 ...
 * NOTE:
 *
 * This program hasn't really been tested against classicOS, and has only
