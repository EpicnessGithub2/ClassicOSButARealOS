...
/*
 * classicOS uses the same boot screen for all the products.
 *
 * Enable this define when classicOS will have different SKUs
 ...
 * - PltRotBarStatus == 1, do palette fading-in (done elsewhere in classicOS);
    ...
    _In_ BOOLEAN TextMode)
{
    ...
    else
    {
         ...
         * to show that classicOS can be still alive when the bar does not
         * appear to progress.
         */
