...
//
// By default, it is a 16MB region, but we hack it to be 32MB for classicOS
//
...
//
// Unlike the old classicOS Memory Manager, ARM³ (and Windows) does not keep track
...
MiBuildPagedPool(VOID)
{
    ...
    // page directory array in the old classicOS Mm is used (but in a less hacky
    // way).
    //
