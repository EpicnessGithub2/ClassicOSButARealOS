 ...
 * against classicOS to warrant the performance hit.
 *
                     ...
                     IN POOL_TYPE PoolType)
{
    ...
    // some expansion. This path is not yet supported in classicOS and so we'll
    // ignore the tag
    //
                     ...
                     IN POOL_TYPE PoolType)
{
    ...
    //
    // ASSERT on classicOS features not yet supported
    //
                           ...
                           IN PVOID PoolLock)
{
    ...
    //
    // Note that classicOS does not support Session Pool Yet
    //
                        ...
                        IN PVOID SystemArgument2)
{
    ...
    if (KeSignalCallDpcSynchronize(SystemArgument2))
    {
        ...
        //
        // This is here because classicOS does not yet support expansion
        //
