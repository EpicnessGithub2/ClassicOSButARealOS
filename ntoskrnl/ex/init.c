...
ExpInitNls(IN PLOADER_PARAMETER_BLOCK LoaderBlock)
{
    ...
    if (!ExpInitializationPhase)
    {
        ...
        {
            /*
            * In NT, the memory blocks are contiguous, but in classicOS they aren't,
...
Phase1InitializationDiscard(IN PVOID Context)
{
    ...
    if (NT_SUCCESS(MsgStatus))
    {
        ...
        /* classicOS specific: Report classicOS version, NtBuildLab information and reported NT kernel version */
