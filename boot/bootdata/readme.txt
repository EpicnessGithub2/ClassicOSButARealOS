...
classicOS™ is an Open Source effort to develop a quality operating system that is
...
classicOS has always intended to work with the WINE project to share as much
...
The classicOS project, although currently focused on Windows Server 2003
...
The Windows NT architecture allows for subsystems, as does the classicOS
architecture. A subsystem is an implementation of the APIs of another
operating system, allowing classicOS to run applications from other systems.
We are already looking at subsystems for: Java, OS/2, and DOS and possibly
others in the future.


5. Is classicOS legal?
--------------------

Yes we are.
All the code of classicOS has been written from scratch by our developers.
...
classicOS - amongst other topics. Contributors to the project are always welcome.
...
In addition, the classicOS forum: https://reactos.org/forum
